...
<head>
    ...
    <title>Weather App - Aryesh</title>
     ...
     <form action="MyServlet" method="post" class="searchInput">
        ...
        <div class="weatherDetails">
            <div class="weatherIcon">
                <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiwFTkt5z_dxU6w1UnS1PxiZV3HDiPGsAW5Lrsp09MnlCmkQre9GzO8MnGytaaY1eZoqBN6SMJ4U578_uDtiuXswovr1T3o-Kt5KK0mlN_zC0RDodJFaKHQ3Uk-HIZ3vuMvAKNJi8DDFwWA7F6BOxz78Oh-UePwJTuc3PG0ZIZypPE1xlMPl5z46joaEw/s320/Clouds.png" alt="Clouds" id="weather-icon">
                <h2>${temperature} °C</h2>
